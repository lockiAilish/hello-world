...
#De la version 3 en adelante de python raw_python es solo input()
h = float(input("Introduce tu estatura en centimetros.- "))#raw_input("Introduce tu estatura en centimetros.- "))
w = float(input("Introduce tu peso en kilogramos.- "))#raw_input("Introduce tu peso en kilogramos.- "))
